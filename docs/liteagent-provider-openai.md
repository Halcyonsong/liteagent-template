...
Flux<OpenAiChatCompletionRawResponse> stream = streamTransport.send(endpoint, baseRequest.getApiKey(), rawRequest);
...
String endpoint3 = OpenAiEndpointResolver.resolveChatCompletionsEndpoint("https://api.openai.com/v1/chat/completions");
