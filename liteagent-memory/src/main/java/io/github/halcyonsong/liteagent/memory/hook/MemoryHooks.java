 ...
 * 记忆窗口 Hook 工厂。
 * <p>
 * 用于创建并注入 Chat 或 Stream Agent 的记忆 Hook。
...
public final class MemoryHooks {
     ...
     * <p>
     * 默认最大消息数沿用 MemoryChatStepHook 的默认值。
     */
    ...
    /**
     * 创建 Chat Agent 使用的记忆 Hook，默认最大消息数为 40。
     *
     * @param store 会话记忆窗口存储
     * @return Chat 侧步骤 Hook
     */
     ...
     * <p>
     * 默认最大消息数沿用 MemoryStreamStepHook 的默认值。
     */
    ...
    /**
     * 创建 Stream Agent 使用的记忆 Hook，默认最大消息数为 100。
     *
     * @param store 会话记忆窗口存储
     * @return Stream 侧步骤 Hook
     */
