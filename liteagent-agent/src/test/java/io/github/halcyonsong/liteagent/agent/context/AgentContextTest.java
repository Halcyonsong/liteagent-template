...
class AgentContextTest {
    ...
    void create_should_initialize_context_fields() {
        ...
        AgentContext context = AgentContext.create("exec-1", invocation);
    ...
    void create_should_reject_invalid_arguments() {
        ...
        assertThrows(IllegalArgumentException.class, () -> AgentContext.create("", invocation));
        assertThrows(IllegalArgumentException.class, () -> AgentContext.create("  ", invocation));
        assertThrows(IllegalArgumentException.class, () -> AgentContext.create("exec", null));
    }
